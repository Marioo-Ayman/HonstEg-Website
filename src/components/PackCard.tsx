...
export function InvestmentCard({
  ...
  return (
    ...
    >
      ...
      {/* Description */}
      <p className={`mb-8 leading-relaxed w-85 ${isDark ? 'text-slate-300' : 'text-slate-600'}`}>
        {description}
      </p>

      {/* Key Details Section */}
      <div className="space-y-4 mb-8">
        <div className={`h-px bg-gradient-to-r ${isDark ? 'from-slate-700 via-slate-600 to-transparent' : 'from-slate-200 via-slate-300 to-transparent'}`} />
